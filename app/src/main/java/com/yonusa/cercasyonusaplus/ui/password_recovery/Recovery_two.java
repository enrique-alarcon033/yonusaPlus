...
public class Recovery_two extends AppCompatActivity {
    ...
    public boolean Cambiar_contraseña(String email,String codigo, String pass) throws JSONException, UnsupportedEncodingException {
        ...
        RequestHandle requestHandle = oHttpClient.post(getApplicationContext(),
                "https://fntyonusa.payonusa.com/api/ActualizarPassword",(HttpEntity) oEntity, "application/json" ,new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody){
                        ...
                        try {
                            ...
                            if (valor.equals("-1")){
                                dialogo.dismiss();
                                Toast.makeText(getApplicationContext(), "Verifica el codigo de recuperacion", Toast.LENGTH_LONG).show();
                                //loader.setVisibility(View.GONE);
                            }
