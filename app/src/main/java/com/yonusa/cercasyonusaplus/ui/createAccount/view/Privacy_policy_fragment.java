...
public class Privacy_policy_fragment extends Fragment {
    ...
    public Privacy_policy_fragment() {
    ...
    public void onButtonPressedForm(Uri uri) {
        if (mListener != null) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        wbPrivacy = view.findViewById(R.id.scv_web_privacy_policy);
        wbPrivacy.loadUrl(ApiConstants.URL_TERMINOS_CONDICIONES);
