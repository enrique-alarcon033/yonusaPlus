package com.yonusa.cercaspaniagua.ui.rutinas;
...
public class eliminar_rutina extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        borrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    eliminar_rutina(nombre.getText().toString());
    ...
    public boolean eliminar_rutina(String nombre) throws JSONException, UnsupportedEncodingException {
        ...
        RequestHandle requestHandle = oHttpClient.post(getApplicationContext(),
                "http://gateway.payonusa.com/api/EliminarCalendarioNotificacion",(HttpEntity) oEntity, "application/json" ,new AsyncHttpResponseHandler() {
